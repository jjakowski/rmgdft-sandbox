...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\columnwidth]{Figure-1_benzene-spectra.pdf}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\columnwidth]{Figure-2_c60}
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=0.99\textwidth]{Figure-3_benzene-dt.pdf}
    \caption{\footnotesize  
...
\begin{figure*}[h!]
    ...
    %\includegraphics[width=0.99\textwidth]{Figure-chlorophyll-v2.pdf}
     \includegraphics[width=0.99\textwidth]{Figure-4_chlorophyll-new-v4.pdf}   
...
\begin{figure*}[h!]
    ...
    \includegraphics[width=0.99\textwidth]{Figure-5_Ag-nanorods.pdf}
