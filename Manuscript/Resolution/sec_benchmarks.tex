...
\subsection{Length- and Velocity-Gauge Consistency: Benzene}

.. benzene discussion and figure

BENZENE FIGURE

%\caption{
Comparison of length- and velocity-gauge RT-TDDFT response for benzene
within RMG.  The length-gauge result is obtained from the imaginary part
of the Fourier-transformed induced dipole,
$-\mathrm{Im}\,\Delta\mu(\omega)$.  For the present velocity-gauge
impulsive perturbation, scaling the imaginary part of the
Fourier-transformed current by a single factor of $1/\omega$ does not
reproduce the frequency dependence of the length-gauge response,
whereas scaling by $1/\omega^{2}$ gives close agreement over the
relevant excitation-energy range.  Constant normalization factors are
applied for comparison of spectral shapes.  A small low-frequency
numerical background was removed prior to the $1/\omega^{2}$ scaling
to prevent amplification of the residual near-zero-frequency response.
The agreement is consistent with the two distinct frequency factors
derived in Sec.~\ref{sec:rmg_vg_frequency_response}.
%}
%--------------------------------------------------------
\subsection{Periodic Cross-Code Benchmarks}
...
\begin{figure*}[ht!]
  ...
  \begin{tabular}{@{}cc@{}}
    ...
    \includegraphics[width=0.48\linewidth]{Figs/out-h2.pdf} &
    \includegraphics[width=0.48\linewidth]{Figs/out-hBN.pdf} \\
    (a) & (b) \\
    %\includegraphics[width=0.48\columnwidth]{Figs/out-Si.pdf} &
    %\includegraphics[width=0.48\columnwidth]{Figs/out-CrI3.pdf} \\
    \includegraphics[width=0.48\linewidth]{Figs/out-Si.pdf} &
    \includegraphics[width=0.48\linewidth]{Figs/out-CrI3.pdf} \\
    (c) & (d)
  \end{tabular}
