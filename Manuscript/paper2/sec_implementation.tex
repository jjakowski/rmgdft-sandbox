...
\myred{[Content outline -- adapt from paper 1 Section 3.2 with
...
- Timing data for benchmark systems: \myred{[add when available]}]}

\myred{[Note: include a brief timing comparison table analogous to
