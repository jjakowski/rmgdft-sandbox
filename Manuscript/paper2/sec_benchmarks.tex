...
\begin{figure}[ht!]
	\begin{tabular}{ll}
   \includegraphics[width=0.5\columnwidth]{Figs/out-h2.pdf} & 
   \includegraphics[width=0.5\columnwidth]{Figs/out-hBN.pdf} \\ 
   a) & b) \\
   \includegraphics[width=0.5\columnwidth]{Figs/out-Si.pdf} &
   \includegraphics[width=0.5\columnwidth]{Figs/out-CrI3.pdf} \\
   c) & d)
	\end{tabular}
  \caption{\footnotesize
	\myblue{ Optical conductivity of (a) 1-D Hydrogen, (b) 2-D hexagonal Boron Nitride (c) 3-D  Silicon,
	(d) spin polarized CrI3 from from RMG compared with Octopus
	}
  }
  \label{fig:h2}
\end{figure}
